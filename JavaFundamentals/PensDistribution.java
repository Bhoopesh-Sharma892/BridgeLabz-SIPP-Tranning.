...
I/P => NONE
O/P => The Pen Per Student is ___ and the remaining pen not dist
*/
...
System.out.println("The Pen Per Student is "+ distributedPens+" and the remaining pen not distributed is " + notDistributed );
}
}